...
const listToVariants = (variantArray, defaultValue) => variantArray.reduce((collection, variant) => ({
  ...collection,
  [variant]: !!defaultValue || false,
}), {});

export default (additionalVariants, overrides) => {
